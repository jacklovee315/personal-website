                ...
                @if (!$paginator->onFirstPage())
                    ...
                    @else
                        <button
                            ...
                            class="relative inline-flex items-center p-2.5 text-sm font-medium text-gray-700 bg-gray-50 border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                ...
                @if ($paginator->hasMorePages())
                    ...
                    @else
                        <button type="button" wire:click="nextPage('{{ $paginator->getPageName() }}')"
                                ...
                                class="relative inline-flex items-center p-2.5 ml-3 text-sm font-medium text-gray-700 bg-gray-50 border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
